...
public class FeedActivity extends AppCompatActivity {
    ...
    @Override
    public boolean onCreateOptionsMenu(Menu menu) { //baglanıcak menu
    ...
    @Override
    public boolean onOptionsItemSelected(MenuItem item) { //tıklandıgında
    ...
    public void download(){  //galeriden sectigimiz gorseli timelineda görmemizi saglayan-yukleyen
                            ...
                            parseFile.getDataInBackground(new GetDataCallback() {
                                ...
                                public void done(byte[] data, ParseException e) {
                                    ...
                                    if ( e == null && data != null){
                                        ...
                                        usernamesFromParse.add(object.get("username"));
